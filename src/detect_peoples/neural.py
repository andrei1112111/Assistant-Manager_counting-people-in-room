...
def find_people(raw_shot_path: str):
...
def make_bounds(boxes, bounded_path: str, raw_shot_path: str) -> int:
    """
    :return: count of bounds
    """
    count = len(boxes)
    if count > 0:
...
def get_peoples_count_from_photo(raw_shot_path: str, bounded_path: str) -> int:
